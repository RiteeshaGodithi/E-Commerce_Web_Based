...
public class SignUpServlet extends HttpServlet {
   private String Username, Password, Re_enterPassword, CustomerName, EmpID;
      ...
      throws ServletException, IOException
   {
      ...
      Re_enterPassword = req.getParameter( "RePassword" );
      CustomerName = req.getParameter( "Name" );
      EmpID = req.getParameter( "ID" );

      System.out.println("Username: "+Username);
	  		System.out.println("Password: "+Password);
	  		System.out.println("Password1: "+Re_enterPassword);
	  		System.out.println("Name: "+CustomerName);
	  		System.out.println("EmpID: "+EmpID);


      Account Acct = new Account(Username, Password, Re_enterPassword, CustomerName, EmpID);
      if (Acct.signUp())
           showSuccess();
      else
